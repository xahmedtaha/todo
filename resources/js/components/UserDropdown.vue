                ...
                <div class="py-1">
                    <form method="post" :action="logoutRoute">
                        ...
                        <MenuItem v-slot="{ active }">
                            <button type="submit" :class="[active ? 'bg-gray-100 text-gray-900' : 'text-gray-700', 'block w-full text-left px-4 py-2 text-sm']">Logout</button>
                        </MenuItem>
                    </form>
                </div>
            </MenuItems>
...
const logoutRoute = route('auth.logout')
